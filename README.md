...
Results
MetricAsymmetricCircularNeuralSuccess Rate~76%~72%~75%Collision Rate~5%~8%~5%Social Violations/ep~1.2~2.1~1.4Path Length (m)~12.8~13.4~13.0Plan Time (ms)~15~11~8*
...
Quick Start
bashpip install numpy scipy matplotlib pandas requests
